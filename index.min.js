...
angular.module('transformators').factory('Transformators', function() {
  var countQuarterTotalPower, countTotalPower, findTransformator, getSource, getTargets, maxPower, setTargets, source, targets, transformatorList, transformatorTargetList;
  maxPower = 15000;
  targets = [];
  source = {
