...
LinkMatrixController = function($scope, $state, Schemas, Transformators, Graph, settings) {
  ...
  $scope.generateResults = function() {
    ...
    return _.each(_.range($scope.settings.loops), function(i) {
      var cTotal, fullLinks, iTotal, isAllVisited, kTotal, links, source, sourceLinks, targets, treeV, wConsumerTotal, wDiffTotal, wTotal, zTotal;
      ...
      _.each(fullLinks, function(link) {
        ...
        link.kud = $scope.settings.includeBuildCost ? lineCost.price * link.line.count + lineBuildCost.price : lineCost.price * link.line.count;
